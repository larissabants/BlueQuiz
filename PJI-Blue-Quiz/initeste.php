...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="./css/initeste.css">

    <title>Blue Quiz - Iniciar Teste</title>
    </head>
    <body id="body-pd">
...
<br>
        ...
        <img  src="./img/gifteste.gif">
        <form action="perg1.php">
            <button type="submit" name="comeco"> Iniciar teste </button>
            </form>
        </div>
